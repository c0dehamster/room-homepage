export const Hero = () => {
	return (
		<section className="hero | tablet:col-span-2 desktop:col-start-3 desktop:col-end-5 desktop:row-start-1 desktop:row-end-2 px-8 py-14 desktop:p-24 flex flex-col justify-start items-start gap-3">
